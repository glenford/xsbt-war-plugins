...
public class MyStartup {
    ...
    private static WebAppContext buildContext() throws IOException {
        ProtectionDomain protectionDomain = MyStartup.class.getProtectionDomain();
        URL location = protectionDomain.getCodeSource().getLocation();

        WebAppContext context = new WebAppContext();
        WebAppClassLoader webAppClassLoader = new WebAppClassLoader(MyStartup.class.getClassLoader(),context);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("This is my startup !!!!!");
